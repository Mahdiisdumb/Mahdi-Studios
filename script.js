...
// Divisions data
const divisions = {
    "Unity": {description:"Handles game dev stuff in Unity. Breaks things, makes chaos.(First Ever divsion EST:DEC:26:23)", employees:[{name:"Mahdi",role:"Head + Founder + CEO + Chief Chaos Officer"}], volunteers:[], retired:[]},
    ...
    "Web": {description:"All the web stuff, site, GitHub chaos, social media.(Formerly the SDSG/Project-SDSG divsion EST:OCT:15:24)", employees:[{name:"Mahdi",role:"Head + Founder + CEO + Chief Chaos Officer"},{name:"Luke",role:"Social Media Manager"},{name:"Chris",role:"Product Manager"},{name:"Andrew",role:"Social Media Manager"},{name:"Jamanson",role:"Accountant"},{name:"Ibraheem",role:"Secretary"}, {name:"Mohamad", role:"Image designer"}],volunteers:[{name:"Sean",role:"Volunteer"},{name:"Blake",role:"Gooner"},{name:"Jacob",role:"Volunteer"},{name:"CJ",role:"Deprecated/Retired"},{name:"Alex",role:"Deprecated/Retired"},{name:"Jason",role:"Deprecated/Retired"}], retired:[{name:"CJ",role:"Deprecated"},{name:"Alex",role:"Deprecated"},{name:"Jason",role:"Deprecated"}]}
};
